...
import dev.baseio.harmony.core.ApiAbstract
...
class HarmonyServiceTest : ApiAbstract<HarmonyService>() {

    private lateinit var service: HarmonyService
    ...
    fun initService(){
        ...
        service = createService(HarmonyService::class.java)
