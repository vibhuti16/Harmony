...
//        val hilt_androidx = "androidx.hilt:hilt-lifecycle-viewmodel:${Versions.a_hilt_version}"
    ...
    /* Android Test */
    object Test {
        val test_orch = "androidx.test:orchestrator:${Versions.test_orchestrator_version}"
    ...
    object ExoPlayer {
        val core =
            "androidx.media3:media3-exoplayer:${Versions.exoplayer_version}"
        val dash =
            "androidx.media3:media3-exoplayer-dash:${Versions.exoplayer_version}"
        val ui =
            "androidx.media3:media3-ui:${Versions.exoplayer_version}"
    }
}